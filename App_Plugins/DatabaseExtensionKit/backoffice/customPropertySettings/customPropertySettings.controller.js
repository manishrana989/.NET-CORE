...
(function () {
    ...
    function PropertySettingsEditor($scope, contentTypeResource, dataTypeResource, dataTypeHelper, formHelper, localizationService, userService, editorService) {
        ...
        function loadValidationTypes() {
            ...
            localizationService.localizeMany(labels)
                .then(function (data) {
                    ...
                    vm.labels.displayInList = data[6];
        ...
        function openDataTypePicker(property) {
            ...
            var dataTypePicker = {
                ...
                view: "/App_Plugins/DatabaseExtensionKit/backoffice/customPropertySettings/customDataTypePicker.html",
                size: "medium",
    ...
    angular.module("umbraco").controller("CustomPropertySettingsController", PropertySettingsEditor);
