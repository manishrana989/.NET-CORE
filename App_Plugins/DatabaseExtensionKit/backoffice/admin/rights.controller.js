(function () {
    ...
    function ContentRightsController($scope, $timeout, contentResource, localizationService, angularHelper, navigationService, overlayService, $http) {
        ...
        function onInit() {
            ...
            $http({
                method: 'GET',
                url: '/Umbraco/backoffice/DatabaseExtensionKit/Permissions/GetUserGoups?nodeId=' + $scope.currentNode.id,
                headers: {
        ...
        */
        ...
        function editPermissions(group) {
            ...
            delete vm.selectedUserGroup.permissions["administration"];
            delete vm.selectedUserGroup.permissions["structure"];

            vm.selectedUserGroup.permissions["content"] = vm.selectedUserGroup.permissions["content"].filter(function (item) {
                return ["F", "D", "A"].indexOf(item.permissionCode) !== -1
            });
        ...
        function save() {
            ...
            $http({
                method: 'POST',
                url: '/Umbraco/backoffice/DatabaseExtensionKit/Permissions/Save',
                headers: {
                    'Content-Type': 'application/json'
                },
                dataType: 'json',
    ...
    angular.module("umbraco").controller("CustomRightsController", ContentRightsController);
