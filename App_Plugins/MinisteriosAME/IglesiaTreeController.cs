...
namespace minamev1.App_Plugins.MinisteriosAME
{
    ...
    [Tree("MinisteriosAME", "iglesiaTreeAlias", TreeTitle = "Iglesias", TreeGroup = "AdministracionGroup", SortOrder = 3)]
    public class IglesiaTreeController : TreeController
    {

        private readonly IMenuItemCollectionFactory _menuItemCollectionFactory;

        public IglesiaTreeController(ILocalizedTextService localizedTextService,
